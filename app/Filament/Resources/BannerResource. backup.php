...
class BannerResource extends Resource
{
    ...
    //    return $allowedFileTypes = ($state->media_types == 'image') ? ['jpg', 'jpeg', 'png'] : ['video/mp4'] ;
        ...
        ->schema([
           ...
           // In your form schema definition
...
->required()
->attributes([
    'id' => 'media-upload-input', // Assign an ID for easy identification
]),
...
->disabled(fn ($record) => empty(optional($record)->media_types)) // Call JavaScript function on change
            ...
            //      ->disabled(fn ($record) => empty($record['media_types']))
            //     ->required()
            //     ->acceptedFileTypes(function ($record) {
            //         // Return accepted file types based on the selected media type
            //         return isset($record['media_types']) && $record['media_types'] === 'image' ? ['image/jpg', 'image/jpeg', 'image/png'] : ['video/mp4'];
            //     }),
                // ->acceptedFileTypes(function ($record) {
